...
import { HintText } from "../../../src/components/base/input/hint-text.tsx";
import { Label as LabelBase } from "./label.tsx";
...
const Separator = (props: ComponentPropsWithRef<"div">) => {
    return (
        <div role="separator" {...props} className={cx("content-center text-display-xl font-medium text-utility-neutral-300", props.className)}>
            -
        </div>
    );
};
